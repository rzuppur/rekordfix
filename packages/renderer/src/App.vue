...
.r-text-xs.r-p-b-lg.r-background-raised
  .r-p-lg(v-if="!collectionLoaded")
    ...
    r-button.r-space(primary :loading="collectionLoading" icon="file_open" :action="actionOpenCollection") Open XML Collection File
    .background-error.r-p-md.r-border-radius-md.r-text-color-red.r-text-medium.r-space(v-if="errorText") {{ errorText }}

  .r-p-lg(v-else)
    r-button.r-m-b-lg(borderless small :action="resetCollection" icon="arrow_back") Back
